...
<section class="durabilitate-head">
    <div class="prod-img-container">
        <img class="img-fluid prod-img-h" src="getsvg.php?svg=terms" alt="terms">
        <h1 class="h1-prod-h left">Termeni si Condiții</h1>
...
<section class="container mb-5 terms-section">
        ...
        <table class="table">
            <tbody>
                <tr>
                    ...
                    <td>Reprezintă modalitatea de a face cunoscute produsele și serviciile oferite de „Aplast” prin accesarea și utilizarea acestuia; termenul ,,site” include toate diviziunile, rubricile, articolele, secțiunile derivate și conținutul lor;</td>
                </tr>
                <tr>
                    <td class="fw-bold">Utilizator</td>
                    <td>Reprezintă orice persoană fizică sau juridică, care accesează Site-ul în scopuri private sau profesionale și care a acceptat Condițiile de Utilizare ale acestuia, îndeplinind în acest sens toate cerințele procesului de înregistrare; prin accesarea Site-ului orice persoană se poate documenta cu privire la produsele și serviciile oferite de Aplast, având posibilitatea de a transmite comenzi online și de a cumpăra în condiții avantajoase;</td>
                </tr>
                <tr>
                    <td class="fw-bold">Utilizare abuzivă</td>
                    <td>Reprezintă utilizarea Site-ului într-un mod contrar practicii în domeniu, a reglementărilor și ale legislației în vigoare sau în orice alt mod care poate produce prejudicii societății Aplast Wood Industry SRL;</td>
                </tr>
                <tr>
                    <td class="fw-bold">Comandă</td>
                    <td>Reprezintă un document electronic, generat ca urmare a accesării Site-ului de către un Client și care intervine ca formă de comunicare între Site și Client;</td>
                </tr>
                <tr>
                    <td class="fw-bold">Contract</td>
                    <td>Reprezintă o COMANDĂ confirmată de către Societate, prin care aceasta este de acord să producă și să livreze Clientului produse și servicii, iar Clientul este de acord să efectueze plata acestora. <br>
                        <span class="d-block ">UTILIZATORII/CLIENȚII sunt rugați să citească cu atenție termenii și condițiile de utilizare ale acestui Site;</span>
                    </td>
                </tr>
            </tbody>
        </table>
    </div>
    <p>1.3. Termenii și Condițiile de utilizare ale site-ului sunt considerate a constitui prevederi minimale aplicabile, accesarea/utilizarea Site-ului supunându-se de drept prevederilor generale ale legislației în vigoare.</p>
    <p>1.4. Termenii și Condițiile de utilizare pot fi modificate oricând prin actualizarea prezentului Site, aceste modificări devenind obligatorii cu efect imediat pentru toți utilizatorii/clienții.</p>
    <p>1.5. Prin accesarea/utilizarea Site-ului, utilizatorii/clienții consimt să respecte Termenii și Condițiile prezentate în continuare, precum și legislația aplicabilă.</p>
    <p>1.6. În cazul în care Site-ul conține link-uri către alte site-uri, Aplast nu este responsabil de politica de confidențialitate a acestora și de orice alte informații prezentate pe aceste site-uri.</p>
    <h6>2. MODALITĂȚI DE UTILIZARE</h6>
    <p>2.1. Site-ul, implicit conținutul său, aparține societății Aplast Wood Industry, fiind protejat de legislația în vigoare privind drepturile de autor și drepturile conexe.</p>
    <p>2.2. Prin accesarea/întrebuințarea/utilizarea Site-ului, persoanele interesate recunosc în mod expres și just că au cunoscut, au înțeles și sunt de acord cu prezentele politici privind Termenii și Condițiile de utilizare.</p>
    <p>2.3. Întrebuințarea Site-ului de către utilizatori/clienți se face pe propria răspundere a acestora și cu luarea la cunoștință a prevederilor prezentului document.</p>
    <p>2.4. Pentru accesarea produselor și serviciilor prezentate pe Site, este necesară completarea unui formular de înscriere, în urma căruia persoana interesată își va crea un cont cu ,,nume de utilizator” și ,,parolă” ; în acest sens, se impune ca utilizatorii să furnizeze date corecte și complete conform formularului de înregistrare și să le actualizeze atunci când apar modificări.</p>
    ...
    <ul>
        <li>dreptul de a restrânge accesul utilizatorilor Site-ului în situația în care comunicările/mesajele și orice alte informații afișate de către aceștia au un conținut ilegal, încalcă drepturile de proprietate intelectuală sau alte drepturi conexe, furnizează informații false în scopul de a induce în eroare clienții actuali/viitori, comentariile/postările au în cuprinsul lor programe/aplicații virusate ori aduc atingere reputației societății;</li>
    </ul>
    <ul>
        <li>dreptul de a desființa (elimina/șterge) în orice moment oricare cont, ceea ce implică anularea accesului utilizatorului la contul său și/sau la Site (de exemplu, în cazul în care se constată încălcarea Termenilor și Condițiilor descrise în prezentul document ori se înregistrează defecțiuni de natură tehnică sau intervin incidente de securitate a informațiilor).</li>
    </ul>
    <h6>4. INTERDICȚII</h6>
    <p>4.1. Este interzisă în mod absolut și expres folosirea produselor și serviciilor prezentate prin intermediul Site-ului în scopul comunicării, publicării sau transmiterii oricărui tip de informații al căror conținut încalcă ordinea publică și regulile de conviețuire socială ori au un caracter ilegal sau aduc atingere drepturilor de proprietate intelectuală și drepturilor conexe.</p>
    <p>4.2. Se interzice, de asemenea, utilizarea oricărui element structural al Site-ului, iar utilizatorul care încalcă această interdicție, va fi răspunzător conform legislației în vigoare.</p>
    <p>4.3. Transmiterea/publicarea oricăror informații/date/indicații prin intermediul tuturor mijloacelor de exprimare (text/mesaj scris, mesaj vorbit, imagini, simboluri, aplicații, fișiere audio/video), precum și alte tipuri de materiale indiferent de sursa de proveniență (publice sau private) de către orice utilizator (persoană fizică/juridică), altul decât Aplast, se efectuează pe răspunderea deplină și exclusivă a acestui utilizator; Aplast nu își asumă în niciun fel conținutul sau modalitățile de comunicare a acestor publicări și nu va răspunde pentru eventuale daune care s-ar produce ca urmare a publicărilor evidențiate mai sus.</p>
    <p>4.4. În cazul în care se identifică pe Site informații de tipul celor menționate în art. 4.1. și 4.3., societatea Aplast își rezervă dreptul de a elimina conținutul acestora.</p>
    <h6>5. MARCĂ ÎNREGISTRATĂ. DREPTURI DE PROPRIETATE INDUSTRIALĂ EXCLUSIVE</h6>
    <p>5.1. ,,Aplast” și alte însemne/logo-uri/simboluri constituie mărci comerciale/înregistrate ale societății Aplast Wood Industry.</p>
    <p>5.2. Mărcile înregistrate aparținând Aplast nu pot fi folosite pentru promovarea unor produse/servicii care nu au legătură cu obiectul de activitate al societății sau pentru care nu s-a obținut în prealabil o autorizație scrisă din partea societatea Aplast Wood Industry S.R.L..</p>
    <p>5.3. Alte mărcile comerciale care apar pe Site pot fi deținute de către Aplast sau se află în proprietatea partenerului/partenerilor contractual(i) al (ai) acestuia.</p>
    <p>5.4. Conținutul Site-ului, cuprinzând toate informațiile incluse prezentate sub formă de text, date, software, fișiere (audio sau video), imagini plastice/statice/logo, elemente de grafică WEB/design, grafice, simboluri/grup de simboluri, programe și orice alte materiale de informare în legătură cu Site-ul, sunt protejate de legislația privind drepturile de autor și drepturile conexe (Legea nr. 8/1996 și actele normative conexe în vigoare) și se află în proprietatea exclusivă a „Aplast”, fiind drepturi rezervate.</p>
    ...
    <ul>
        <li>de a modifica/completa/actualiza Termenii și Condițiile de utilizare ale Site-ului;</li>
        <li>de a completa/reactualiza orice produs/serviciu/aplicație sau drept de folosire a acestora;</li>
        <li>de a adăuga reguli/indicații/restricții cu caracter obligatoriu privind conținutul Site-ului.</li>
    </ul>
    <h6>7. RESTRÂNGEREA RESPONSABILITĂȚII</h6>
    <p>7.1. ,,Aplast” își restrânge sfera răspunderii, fiind exclusă plata daunelor de orice fel, în cazul apariției unor situații neplăcute, cauzate de: accesarea/utilizarea Site-ului sau a oricărui element/rubrică/secțiune a acestuia, dificultatea/întârzierea în accesarea/utilizarea Site-ului, indisponibilitatea Site-ului, defecțiuni tehnice ale sistemului informatic/programelor/aplicațiilor/serviciilor Site-ului, suspendarea temporară/definitivă/parțială/totală a Site-ului, modificarea/completarea/refacearea/ștergerea materialelor publicate.</p>
    <p>7.2. Nu este angajată răspunderea Site-ului, fiind exclusă plata daunelor de orice fel, în următoarele situații (enumerarea nu este limitativă): pierderea parțială/totală a datelor, pierderi cauzate de prezența unor programe virusate sau a unor aplicații/materiale care prejudiciază sistemul, pierderi care decurg din evenimente/fapte/împrejurări independente de voința sau influența ,,Aplast” și care nu puteau fi anticipate într-un termen rezonabil.</p>
    ...
    <p>10.3. Confirmări: Prezentul document conținând termenii și condițiile de utilizare ale Site-ului cuprinde în întregime acordul dintre utilizatori/clienți și scu privire la utilizarea Site-ului. Orice declarație/relatare/cerință care nu este inclusă în acest document, nu va genera obligații în sarcina operatorului sau a utilizatorilor/clienților, dacă nu a existat un acord scris prealabil încheiat între Aplast și utilizatori/clienți.</p>
    <h6>11. CONDIŢII GENERALE DE VÂNZARE</h6>
    <p>Prezentele condiții reprezintă cadrul general în care se desfășoară activitatea de vânzare online, constituit într-un sistem de vânzare organizat de Aplast. Aceste clauze formează condițiile contractului de vânzare online asupra cărora, prin comanda transmisă, clientul (persoană fizică/persoană juridică) își exprimă expres, neechivoc, în mod liber și în cunoștință de cauză consimțământul, prin plasarea comenzii.</p>
    <p>Condițiile generale de vânzare cuprind următoarele secțiuni:</p>
    <ul>
        <li>Pagina de produs</li>
        <li>Modalitățile de livrare</li>
        <li>Politica de retur</li>
        <li>Modalitățile de plată</li>
        <li>Garanțiile acordate</li>
        <li>Politica de procesare a datelor cu caracter personale</li>
        <li>Politica de cookies</li>
    </ul>
    <h6>PAGINA DE PRODUS</h6>
    ...
    <p>,,Aplast” oferă clienților, așa cum sunt definiți la art. 2 pct. 1 din OUG nr. 34/2014 (consumator – orice persoană fizică sau grup de persoane fizice constituite în asociaţii, aşa cum sunt definite la art. 2 pct. 2 din Ordonanţa Guvernului nr. 21/1992 privind protecţia consumatorilor,republicată, cu modificările şi completările ulterioare, serviciul de returnare al produselor conform politicii interne si legislatiei in vigoare)</p>
    <h6>EXERCITAREA DREPTULUI DE RETRAGERE</h6>
    <p>Conform OUG nr. 34/2014 privind drepturile consumatorilor în cadrul contractelor încheiate cu profesioniștii, consumatorul benficiază de 14 zile pentru a se retrage (perioada de retragere) din contract fără a fi nevoit să justifice decizia de retragere și fără a suporta alte costuri decât costurile suplimentare.</p>
    <p>Termenul de 14 zile intră în vigoare în momentul în care consumatorul intră în posesia fizică a produselor.</p>
    <p>Consumatorul va trebui să suporte costul aferent returnării produselor în caz de retragere. Costurile suplimentare reprezintă orice costuri (transport, livrare, diminuare a valorii produselor care rezultă din manipulări, altele decât cele necesare pentru determinarea naturii calităților și funcționării produselor, taxe poștale sau de orice altă natură) care urmează a fi suportate de consumator cu ocazia exercitării dreptului de retragere.</p>
    <p>,,Aplast” oferă posibilitatea de retur a produselor în 14 de zile calendaristice, doar pentru produsele standard, nepersonalizate. Rambursarea sumelor se face în cel mai scurt timp de la transmiterea intenției cumpărătorului de renunțare și recepționarea fizică a produselor în punctul de lucru dar nu mai târziu de 14 zile calendaristice, fără alte cheltuieli suplimentare (de ex., comisioane) în afara cheltuielilor directe de returnare a produselor care se vor scădea din prețul plătit (costurile aferente serviciului de curierat nu sunt returnabile);</p>
    <p>Restituirea se va face astfel: prin virament bancar, pentru plățile achitate prin card.</p>
    <h6>Procedură:</h6>
    <p>Înainte de expirarea perioadei de retragere, consumatorul informează societatea cu privire la decizia sa de retragere din contract. În acest scop, consumatorul poate alege una dintre următoarele variante:</p>
    <p>a) de a folosi modelul de formular de retragere prevăzut în anexă;</p>
    <p>b) de a face orice altă declaraţie neechivocă în care îşi exprimă decizia de retragere din contract.</p>
    <h6>Efectele retragerii:</h6>
    <p>Exercitarea dreptului de retragere pune capăt obligaţiilor părţilor contractuale, după caz:</p>
    <p>a) de a executa contractul;</p>
    <p>b) de a încheia un contract, în cazul în care consumatorul a efectuat o comandă.</p>
    <h6>Obligaţiile care revin depozituluicuferestre în cazul retragerii:</h6>
    <p>(1) rambursează toate sumele pe care le-a primit drept plată din partea consumatorului, inclusiv, după caz, costurile livrării, fără întârziere nejustificată şi, în orice caz, nu mai târziu de 14 zile de la data la care este informat de decizia de retragere din contract a consumatorului în conformitate cu art. 11 al OUG nr. 34/2014 și folosind aceleaşi modalităţi de plată ca şi cele folosite de consumator pentru tranzacţia iniţială, cu excepţia cazului în care consumatorul a fost de acord cu o altă modalitate de plată şi cu condiţia de a nu cădea în sarcina consumatorului plata de comisioane în urma rambursării. (2) nu este obligat să ramburseze costurile suplimentare în cazul în care consumatorul a ales în mod explicit un alt tip de livrare decât livrarea standard oferită. (3) ,,Aplast” poate amâna rambursarea până la data recepţionării produselor care au făcut obiectul vânzării sau până la momentul primirii unei dovezi din partea consumatorului conform căreia acesta a trimis produsele către ,,Aplast”, luându-se în considerare data cea mai apropiată.</p>
    <h6>Obligaţiile consumatorului în cazul retragerii:</h6>
    <p>(1) returnează produsele în decurs de cel mult 14 zile de la data la care acesta a comunicat decizia sa de retragere din contract, cu condiția ca produsele să nu fi fost puse în operă (montate în zidărie sau structura clădirii). Termenul este respectat dacă produsele sunt trimise înapoi de consumator înainte de expirarea perioadei de 14 zile. (2) Atunci când consumatorul îşi exercită dreptul de retragere după transmiterea cererii în conformitate cu art. 7 alin. (3) sau cu art. 8 alin. (8) ale OUG nr. 34/2014, consumatorul plăteşte societății o sumă proporţională cu ceea ce s-a furnizat până la momentul în care consumatorul a informat cu privire la exercitarea dreptului de retragere, în raport cu acoperirea totală a contractului. Suma proporţională care trebuie plătită de către consumator este calculată pe baza preţului total convenit în contract. Dacă preţul total este excesiv, suma proporţională este calculată pe baza valorii de piaţă a ceea ce s-a furnizat.</p>
    <h6>Pot fi returnate produse care:</h6>
    <ul>
        <li>nu depășesc termenul de 14 de zile de la data primirii;</li>
        <li>corespund specificațiilor tehnice menționate în comandă;</li>
        <li>nu au făcut obiectul unei comenzi special (produse cut-to-size);</li>
        <li>nu au fost distinct personalizate la cererea consumatorului;</li>
        <li>nu au fost executate după specificațiile consumatorului</li>
        <li>nu prezintă urme de lovire sau deteriorare;</li>
        <li>produsele sunt obligatoriu returnate cu toate accesoriile și eticheta în starea în care au fost recepționate (fără urme de utilizare, deteriorare, lovire);</li>
    </ul>
    <p>Nerespectarea condițiilor de mai sus, precum și punerea produsului, prin orice mijloc, într-o stare necorespunzătoare repunerii în vânzare, duce la refuzul returului.</p>
    <p>Produsele se returnează însoțite de factura fiscală precum și de documentația aferentă (fișe tehnice, manuale de utilizare, documentație tehnică, certificate de garanție și/sau conformitate).</p>
    <h6>MODALITĂȚILE DE PLATĂ</h6>
    <p>Dupa selectarea produselor dorite, alegeți plata prin „card” și plasați comanda. După verificarea și confirmarea stocurilor de către consultantul de vânzări al ,,depozituluicuferestre” veți primi pe adresa de email o ofertă (alături de factura proformă) cu datele de identificare necesare pentru efectuarea plății.</p>
    <p>Datele solicitate clientului pentru emiterea facturii către persoane fizice sunt:</p>
    <ul>
        <li>Nume și prenume cumpărător</li>
        <li>CNP</li>
        <li>Adresa</li>
        <li>Telefon</li>
        <li>Adresa de e-mail</li>
    </ul>
    <p>Datele solicitate clientului pentru emiterea facturii către persoane juridice sunt:</p>
    <ul>
        <li>Denumirea societății</li>
        <li>Sediul Social</li>
        <li>Adresa de livrare</li>
        <li>Persoana de contact</li>
        <li>Număr de telefon</li>
        <li>Adresa de e-mail</li>
        <li>Nr. Înregistrare la Registrul Comerțului</li>
        <li>Cod de identificare fiscală</li>
        <li>Banca</li>
        <li>Cont IBAN</li>
    </ul>
    <p>Datele contului în care se efectuează plata sunt următoarele:</p>
    <p>Denumire: S.C. APLAST WOOD INDUSTRY S.R.L. , CUI: RO 26856598, OTP BANK, Cont RON - RO06OTPV660001168749RO01</p>
    <p>Important! La completarea ordinului de plată la rubrica: (după caz) ”reprezentând”, “destinația plății”, “valoarea reprezintă” vă rugăm să scrieți numărul comenzii online, primită pe email.</p>
    <h6>CONDIŢII GENERALE DE GARANŢIE</h6>
    <p>Toate produsele fabricate şi vândute de către Aplast beneficiază de condiţii de garanţie conform legislaţiei în vigoare.</p>
    <p>Aplast va fi responsabil pentru orice defecțiune a produselor în legătură cu care Clientul a depus o reclamație în perioada de garanție (Cererea de garanție) și va remedia orice defecțiune în termen de 15 zile lucrătoare de la primirea Pretenției de Garanție, prin:</p>
    <p>(i) repunerea, pe propria cheltuială, a părților defecte ale produselor sau înlocuirea produselor defecte;</p>
    <p>(ii) suportarea tuturor costurilor legate de înlocuirea sau repararea produselor defecte.</p>
    <p>Orice costuri de înlocuire sau reparare trebuie să fie convenite în prealabil de către Părți.</p>
    <p>Cererea de garanție va fi efectuată de către Client imediat după descoperirea defectului (și, în orice caz, în conformitate cu termenul prevăzut de lege pentru remedierea defectului) și trebuie să precizeze în mod rezonabil temeiul acestei creanțe. Această garanție acoperă și lucrările de instalare.</p>
    <h6>LIMITĂRI</h6>
    <p>Toate garanțiile asumate de către ,,Aplast” în baza prezentului Contract și / sau conform legii aplicabile sunt condiționate de montarea și utilizarea Produselor în conformitate cu instrucțiunile transmise Clientului, instrucțiuni ce vor fi respectate de orice agent, subcontractant, partener comun al Cumpărătorului sau al Beneficiarului sau al oricărei alte persoane care acționează în numele sau cu autorizarea acestuia. Nu va fi răspunzător pentru niciun defect sau pentru orice pierdere/deteriorare a Produselor în măsura în care este cauzată de oricare dintre următoarele: (i) montarea incorectă a produselor, în cazul în care s-a realizat în regie proprie; (ii) orice utilizare, depozitare, operare, reparație, modificare sau întreținere a Produselor sau a unor părți ale acestora, cu excepția cazului în care Aplast a autorizat în scris acest lucru;</p>
    <p>(iii) forța majoră (iiii) acțiunile sau omisiunile Clientului (sau ale oricărui agent, subcontractant, partener/ asociat comun al Cumpărătorului sau ale oricărei alte persoane care acționează în numele sau cu autorizarea acestuia) și / sau ale Beneficiarul, inclusiv nerespectarea obligațiilor sale în temeiul prezentului Acord, cu excepția cazului în care aceste acte sau omisiuni au fost autorizate de către ,,Aplast”. ,,Aplast” nu va fi răspunzător pentru niciun defect pentru care a fost livrată o cerere de garanție după expirarea perioadei de garanție. În cazul în care Cumpărătorul va încălca obligațiile ce îi revin față de ,,Aplast”, acesta din urmă nu va avea nicio obligație sau răspundere în legătură cu Produsele furnizate în temeiul contractului.</p>
