...
<section class="pvcAl-head">
    ...
    <div class="mt-5 top">
        <h1 class="title mb-2">Ferestre</h1>
    </div>
    ...
    <div class="container d-flex flex-row justify-content-center gap-4 mt-5 mb-5 mom">
        <a href="ferestre.php" class="lines-image-container position-relative">
            <img class="img-fluid linesImage lines-zoom" src="./images/ferestreAL59.webp" alt="pvc">
        ...
        <a href="ferestre.php" class="lines-image-container position-relative">
            <img class="img-fluid linesImage lines-zoom" src="./images/ferestreAL68.webp" alt="pvc">
        ...
        <a href="ferestre.php" class="lines-image-container position-relative">
            <img class="img-fluid linesImage lines-zoom" src="./images/ferestreAL99.webp" alt="pvc">
        ...
        <a href="ferestre.php" class="lines-image-container position-relative">
            <img class="img-fluid linesImage lines-zoom" src="./images/ferestreAL77.webp" alt="pvc">
            <span class="category-image-text-aluminiu position-absolute translate-middle">APLAST AL 77</span>
            <span class="category-image-sub-text-aluminiu position-absolute translate-middle">Reynaers Masterline 8 HI</span>
        </a>
        <a href="ferestre.php" class="lines-image-container position-relative">
            <img class="img-fluid linesImage lines-zoom" src="./images/Aplast_Al_97.webp" alt="pvc">
