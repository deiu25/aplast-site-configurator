...
<section class="production-mid mt-5">
    <div class="prod-img-container">
        <img class="img-fluid prod-img-m" src="./images/instalatori_banner_mid.webp" alt="production">
        <h1 class="h1-prod-m bottom">Ne mândrim cu experiență de piață începând din 2002, timp în care am investit în producție eficientă, calitate și oameni bine pregătiți</h1>
    </div>
</section>
