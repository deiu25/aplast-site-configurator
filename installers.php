...
<section class="production-head">
    ...
    <div class="mt-5 top">
        <h1 class="title mb-2">Instalatori</h1>
        <p class="p-center-production fs-5 fw-bold text-muted mt-3">Ferestrele și ușile Aplast sunt construite cu gândul la instalator - simplu de montat, economisind timp prețios la locul de muncă.</p>
    </div>
</section>

<section class="lines-production-container">
    <div class="arrow-container mb-5">
    ...
    <div class="container">
        <div class="row gx-5">
            <div class="col-lg-6 order-lg-2">
                <img class="img-fluid aboutImage" src="./images/installer.webp" alt="installer">
            </div>
            <div class="col-lg-6 order-lg-1 pctDeVanzare aboutLeft">
                <h1 class="production-subtitle">Partenerul tău din 2002</h1>
...
<section class="production-mid mt-5 mb-5">
    <div class="prod-img-container">
        <img class="img-fluid inst-img-m" src="./images/instalatori_banner_mid.webp" alt="production">
        <h1 class="h1-inst-m bottom">Ne mândrim cu experiență de piață începând din 2002, timp în care am investit în producție eficientă, calitate și oameni bine pregătiți</h1>
    </div>
</section>
